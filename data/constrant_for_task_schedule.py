...
query_schedule_template = (
    "你将扮演智小伴,现在时间是{{cur_time}},请你根据用户的日程列表,生成用户的日程提醒,要求语言表达自然流畅,态度温和,请仿照给出的示例回复\n\n"
    "示例:\n"
    "用户日程为：\n"
    "还需完成5项任务任务\n"
...
query_schedule_template_v2 = (
    "你将扮演智小伴,请你根据用户的日程列表,结合用户所说,帮助他总结对应的日程及时间,针对性给出相关建议,要求语言表达自然流畅,如果无日程,则回复:您当前无日程\n\n"
    "[示例start]\n"
    "用户日程：\n"
    "血压测量,时间：8:00、20:00\n"
    "用餐,时间：11：00、17：00\n"
