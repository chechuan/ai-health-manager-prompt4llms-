...
# 输出示例
亲爱的，你的高血压情况似乎需要更密切的关注。早上起床头晕可能是血压晨峰现象，这可能在高血压管理中是一个重要的信号。建议你每日监测血压，特别是起床后一小时内。同时，保持规律作息，避免突然站起。请咨询医生是否需要调整药物，可能需要加用一种早晨起效的降压药。考虑到你的症状持续，应尽快就医，可能需要做24小时动态血压监测，甚至心电图检查，以评估心血管风险。记得，健康是我们的共同目标，我们一起面对。"""
...
你是一个智能健康助手，请你根据用户已知信息，总结用户的饮食行为、运动行为、睡眠行为。
# 输出要求
...
## 生活习惯
饮食方面，近一周的主食以面食为主，多摄入碳水化合物如拉面，偏好油炸和高盐食物如红烧肉和咸菜类，蔬菜和优质蛋白质摄入不足，存在营养不均衡。运动方面，近一周偶尔进行低等强度运动如散步，运动频率较低。睡眠方面，近一周入睡时间晚且不规律，其中5月27日睡眠时长6小时，5月28日睡眠时长仅4小时，存在入睡困难和睡眠不足的情况。
## 血压数据
| date       | 收缩压 | 舒张压 | 单位 | 血压等级  |
$bp_msg
...
Assistant: 亲爱的，我注意到你的血压在最近两天有所波动，5月1日的血压达到了1级高血压的水平，这需要我们密切关注。高血压可能会增加心脏和血管的负担，长期下来可能对你的健康造成潜在威胁，比如心脏病和中风。你的生活习惯中，食物选择上可能过于偏重碳水化合物，且营养不够均衡，这对控制血压不利。
