...
blood_pressure_inquiry_prompt = """# 已知病人信息如下:
## 血压数据
|date|收缩压|舒张压| 单位|
{0}
## 病人用药情况
...
assistant：
亲爱的，我注意到你的血压在最近两天有所波动，5月1日的血压达到了1级高血压的水平，这需要我们密切关注。高血压可能会增加心脏和血管的负担，长期下来可能对你的健康造成潜在威胁，比如心脏病和中风。你的生活习惯中，食物选择上可能过于偏重碳水化合物，且营养不够均衡，这对控制血压不利。
...
hssistant:你作为一个具备医疗知识的家庭伙伴,分析用户的已知信息,输出指导建议"""