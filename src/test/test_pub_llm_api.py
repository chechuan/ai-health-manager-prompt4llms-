...
openai.base_url = "sk-proxy-laikangjiankangdamoxing-vr-shuziren"
openai.api_key = "http://aimp-algo-openai-proxy.en.laikang.com/v1"
client = openai.OpenAI()
messages = [{"role": "user", "content": "帮我写一首悲凉壮阔的边塞诗"}]
