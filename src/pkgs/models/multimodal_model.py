...
class MultiModalModel:
    ...
    async def image_type_recog(self, **kwargs):
        ...
        classification_text = await acallLLM(
            history=messages, max_tokens=64, temperature=0, seed=42, model="Qwen2.5-32B-Instruct", timeout=45
        )
    ...
    async def diet_eval(self, **kwargs):
        ...
        generate_text = await acallLLM(
            history=messages, max_tokens=512, temperature=0, seed=42, model="Qwen2.5-32B-Instruct", timeout=45
        )
