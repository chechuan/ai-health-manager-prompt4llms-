...
from src.pkgs.models.proactivate_service.qwen_agent.llm.schema import ASSISTANT, FUNCTION, USER, ContentItem, Message
...
class BaseFnCallModel(BaseChatModel, ABC):
    ...
    def __init__(self, cfg: Optional[Dict] = None):
        ...
        if fncall_prompt_type == 'qwen':
            from src.pkgs.models.proactivate_service.qwen_agent.llm.fncall_prompts.qwen_fncall_prompt import FN_STOP_WORDS, QwenFnCallPrompt
            ...
            from src.pkgs.models.proactivate_service.qwen_agent.llm.fncall_prompts.nous_fncall_prompt import NousFnCallPrompt
