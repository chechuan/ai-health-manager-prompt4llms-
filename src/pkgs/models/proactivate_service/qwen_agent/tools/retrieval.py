...
from src.pkgs.models.proactivate_service.qwen_agent.settings import DEFAULT_MAX_REF_TOKEN, DEFAULT_PARSER_PAGE_SIZE, DEFAULT_RAG_SEARCHERS
from src.pkgs.models.proactivate_service.qwen_agent.tools.base import TOOL_REGISTRY, BaseTool, register_tool
from src.pkgs.models.proactivate_service.qwen_agent.tools.doc_parser import DocParser, Record
from src.pkgs.models.proactivate_service.qwen_agent.tools.simple_doc_parser import PARSER_SUPPORTED_FILE_TYPES
...
class Retrieval(BaseTool):
    ...
    def __init__(self, cfg: Optional[Dict] = None):
        ...
        if len(self.rag_searchers) == 1:
            ...
            from src.pkgs.models.proactivate_service.qwen_agent.tools.search_tools.hybrid_search import HybridSearch
