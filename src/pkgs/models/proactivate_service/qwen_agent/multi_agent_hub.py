...
from src.pkgs.models.proactivate_service.qwen_agent.agent import Agent
...
class MultiAgentHub(ABC):
    ...
    def nonuser_agents(self):
        from src.pkgs.models.proactivate_service.qwen_agent.agents.user_agent import UserAgent  # put here to avoid cyclic import
