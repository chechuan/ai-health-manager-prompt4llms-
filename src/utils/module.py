...
#             "role": "1",
#             "content": sentence,
#             "sendTime": "2024-10-12 17:35:15"
#         }],
#         "promptParam": {
#             "familyDoctor": 1,
#             "currentDate": "2024年05月29日",
#             "askExerciseTabooXt": "",
#             "askSix": "",
#             "askExerciseHabbit": "",
#             "askName": "",
...
#
#     try:
#         resp = requests.post(API_URL, headers={"Content-Type": "application/json"}, data=json.dumps(payload), timeout=15)
#         full_text = resp.text
#
#         is_blocked = "convBlocked" in full_text or BLOCK_RESPONSE in full_text
#         remark = ""
#
#         results.append({
#             "序号": idx,
#             "输入句子": sentence,
#             "是否被拦截": "是" if is_blocked else "否",
#             "备注": remark
#         })
#
#     except Exception as e:
